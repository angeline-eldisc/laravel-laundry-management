...
<div class="row">
    <div class="col-md-12">
        <div class="user-data m-b-30">
            <h3 class="title-3 m-b-30"><i class="zmdi zmdi-account-calendar"></i>Profile {{ $cashier->name }}</h3>
            <div class="p-l-44 p-b-44">
                <div class="row">
                    <div class="col col-md-3">
                        <div class="img-circle-costum img-200 pull-left p-t-10 p-b-10">
                            @if ($cashier->profile)
                                <img src="{{ asset('images/users/'.$cashier->profile) }}" alt="user" />
                            @else
                    ...
                    <div class="col-12 col-md-9 vertical-center">
                        <h1>
                            {{ $cashier->name }}<br>
                            <form action="{{ route('users.cashier.deleteProfile', $cashier->id) }}" method="POST" class="float-left">
                                @csrf
                                {{ method_field('POST') }}
                ...
                <div class="fs-20 p-t-20">
                    ...
                    <div class="row p-b-10">
                        ...
                        <div class="col-12 col-md-9">
                            <span class="role kasir">{{ $cashier->role }}</span>
                        </div>
                    </div>
                    ...
                    <div class="row text-center">
                        <div class="col col-md-12">
                            <a href="{{ route('users.cashier.index') }}" class="btn btn-secondary btn-lg">Back</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('users.cashier.updateProfile', $cashier->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal" autocomplete="off">
                    @csrf
                    {{ method_field('PUT') }}
