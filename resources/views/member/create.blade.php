    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body card-block p-5">
                <h3 class="title-3 m-b-30"><i class="zmdi zmdi-account-calendar"></i>add member</h3>
                <form action="{{ route('members.store') }}" method="post" enctype="multipart/form-data" class="form-horizontal" autocomplete="off">
                    @csrf
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-6">
                            <textarea name="address" class="form-control{{ $errors->has('address') ? 'is-invalid' : '' }}" id="textarea-input" rows="4" class="form-control">{{ old('address') }}</textarea>
                            ...
                            <div class="col col-md-12">
                                <div class="form-check-inline form-check">
                                    <label for="inline-radio1" class="form-check-label">
                                        <input type="radio" id="inline-radio1" name="gender" value="Male" style="margin-left: -15px;" class="form-check-input"  checked>Male&nbsp;&nbsp;&nbsp;
                                    </label>
